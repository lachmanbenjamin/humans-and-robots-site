# A2P 10DLC Campaign Resubmission — fix the "opt-in information" rejection

The 1823 campaign was rejected for **opt-in information**. The fix: show carriers a clear, documented opt-in flow. The contact form at https://humansnrobots.com/contact now has a phone field + an (unchecked) SMS consent checkbox linking to https://humansnrobots.com/sms-terms. Use the exact text below in the campaign resubmission.

IMPORTANT account/number note: The 1823 number lives in the PARENT account "My first Twilio account". The A2P Brand + Campaign and the attached number must be in the SAME account. Resubmit the campaign in the account that owns 1823, and confirm +12245071823 is attached to it.

---

## CAMPAIGN USE CASE
Low Volume Mixed  (or "Mixed" / "Customer Care" if Low Volume isn't offered)

## CAMPAIGN DESCRIPTION
Humans & Robots, LLC sends customer-care and notification text messages to people who contact us through our website or who are existing customers. Messages include replies to inquiries submitted on our contact form, appointment and follow-up reminders, service and account notifications, and occasional updates about services the customer requested. Volume is low.
...
- Privacy Policy: https://humansnrobots.com/privacy

## RESUBMISSION CHECKLIST
- [ ] Contact-form consent checkbox is LIVE on humansnrobots.com/contact (push the site change first — carriers may visit the URL).
- [ ] Take a screenshot of the contact form showing the phone field + consent checkbox (some reviews ask for it).
- [ ] In the rejected campaign, edit the "How do end users consent" field with the text above.
- [ ] Confirm sample messages include STOP + HELP.
- [ ] Confirm +12245071823 is attached to the campaign and the campaign is in the same account as 1823.
- [ ] Resubmit.
